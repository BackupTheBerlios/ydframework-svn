...
function AutoSuggest( elementID, divID, suggestions, widthPX )
{
	...
	var TAB = 13;  //ENTER is 13, TAB is 9;
	var ESC = 27;
	var KEYUP = 38;
	var KEYDN = 40;
...
//			if (this.value != me.inputText && this.value.length > 0)
	...
	this.displayDiv = function( newsuggestions ){

//		if (newsuggestions != null){ this.eligible = newsuggestions; }
//		else{ 
		me.getEligible( newsuggestions ); //}
	...
	********************************************************/
	this.useSuggestion = function( useFocus )
	{
...
//			if (useFocus == true){
	...
	********************************************************/
	this.getEligible = function( newsuggestions )
	{
		if (newsuggestions != null) { this.eligible = newsuggestions; return; }
