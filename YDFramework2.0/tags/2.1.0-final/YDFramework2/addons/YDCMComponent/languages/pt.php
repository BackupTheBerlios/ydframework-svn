...
$GLOBALS['t']['not published'] = 'Nуo publicado';
$GLOBALS['t']['schedule'] = 'Calend&aacute;rio';

$GLOBALS['t']['translate'] = 'Traduzir';
$GLOBALS['t']['translate to'] = 'Traduzir para';

$GLOBALS['t']['total versions'] = 'Total de versѕes';
$GLOBALS['t']['general config'] = 'Configuraчуo geral';
$GLOBALS['t']['content versions'] = 'Versѕes';
